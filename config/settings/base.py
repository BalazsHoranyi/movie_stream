...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'movie_stream.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Balazs Horanyi""", 'balazshoranyi01@gmail.com'),
]
...
SOCIALACCOUNT_ADAPTER = 'movie_stream.users.adapters.SocialAccountAdapter'
